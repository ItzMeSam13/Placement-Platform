...
async function handleLogin(event) {
    ...
    try {
        ...
        window.location.href = '/student_dashboard'; // Redirect to student dashboard after successful login
    } catch (error) {
...
async function handleRegistration(event) {
    ...
    try {
        ...
        window.location.href = '/student_dashboard'; // Redirect to dashboard after successful registration
    } catch (error) {
